...
environments {
    development {
        grails.serverURL = "http://192.168.2.5:8080/swapper"
        ...
        oauth {
            providers {
                facebook {                                          // facebook provider configuration
                    ...
                    successUri  = 'http://192.168.2.5:8080/swapper/socialManager/facebookSuccessHandler'
                    failureUri  = 'http://192.168.2.5:8080/swapper/socialManager/facebookFailureHandler'

                    callback    = "http://192.168.2.5:8080/swapper/oauth/facebook/callback"
