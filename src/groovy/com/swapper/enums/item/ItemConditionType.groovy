...
public enum ItemConditionType {
    ...
    NEW ('New', 'item.condition.type.new'),                     // defines a new condition type
    USED ('Used', 'item.condition.type.used')                   // defines a used condition type
     ...
     */
    public ItemConditionType(String description, String i18nCode) {
